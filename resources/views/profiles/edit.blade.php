            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profiles.update',auth()->user()->username)}}" style="color: white;" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="avatar" class="col-md-4 col-form-label text-md-end">Profile Picture</label>

                            <div class="col-md-6">
                                <div class="flex">
                                    <input id="avatar" type="file" class="form-control @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" >
                                    <p style="position: absolute; left: 130px;" >Current Profile Picture</p>
                                    <img src="{{asset('storage/'. Auth::user()->avatar )}}" width="60">
                                </div>
